...
module.exports = function(settings) {
  ...
  function handleClick(event){
    ...
    if (classList.contains('contract')) {
      ...
      startJavascriptEditor(contract.js,true)
      ...
      startJavascriptEditor('// Insert world-changing code here\n',false)
  ...
  function startJavascriptEditor(textContent,readOnly) {
    var container = appElements.details.querySelector('#code-editor-container')
  ...
  function extractNewContractData() {
    return {
      ...
      js: innerText(document.getElementById('code-editor-container')),
    }
  }
